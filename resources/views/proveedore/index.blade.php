                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            {{ $item->persona->estado == 1 ? '¿Seguro que quieres desactivar el proveedor?' : '¿Seguro que quieres activar el proveedor?' }}
                                        </div>
        ...
        $(document).ready(function() {
            $('#datatablesSimple').DataTable({
                ...
                buttons: [{
                        ...
                        title: 'Informe de Proveedores - ' + obtenerFechaYHora()
                    },
                    {
                        extend: 'pdfHtml5',
                        exportOptions: {
